...
export const MenuButton = ({ icon, label, subtitle, badge, isActive, onClick }: MenuButtonProps) => {
  ...
  return (
    <motion.button
      ...
      className={`${styles["menu-btn"]} ${isActive ? styles["btn-active"] : ""} relative flex w-full items-center gap-3 rounded-xl px-4 py-5 text-left sm:gap-4 sm:px-[18px] sm:py-6 ${
        isActive
          ? "text-white"
